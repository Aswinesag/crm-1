  ...
  return (
    <div id="table-width-fixed" className="mt-4">
      ...
      <div>
        ...
        / <span className="text-[#C2410C]">Follow-up</span>
      </div>
      ...
      <div className="mt-4">
        ...
        <p className="text-gray-600 mt-3 ml-1">
          Monitor follow-up leads and customer interactions
        </p>
                ...
                paginatedLeads.map((lead) => (
                  ...
                  >
                    ...
                    <td className="px-4 py-4 text-blue-600">
                      <Link
                        to={`/view/followup/${lead._id}`}
                        state={{ fromSection: "followup" }}
                    ...
                    <td className="px-4 py-4">
                      ...
                      >
                        {[lead.status, "Quotation", "Converted", "Lost"]
